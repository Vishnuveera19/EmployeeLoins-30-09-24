...
import { PAYMBRANCHES, PAYMCOMPANIES, PAYMDEPARTMENT, REPORTS, SAVE } from '../../serverconfiguration/controllers';
...
const DepartForm = () => {
  ...
  const validationSchema = yup.object({
    ...
    vDepartmentName: yup
      .string()
      .max(40, 'Department Name should be at most 40 characters')
      .required('Department Name is required')
      .matches(/^[A-Za-z0-9\s]{1,40}$/, 'Department Name should contain 1 to 40 characters'),
    status: yup
      .string()
    ...
    onSubmit: async (values) => {
      try {
        const query = `
          ...
          VALUES 
          ('${values.pnCompanyId}', '${values.pnBranchId}', '${values.vDepartmentName}', '${values.status}') 
        `;
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  variant="outlined"
                  value={formik.values.vDepartmentName}
                  onChange={formik.handleChange}
                  onBlur={formik.handleBlur}
                  error={formik.touched.vDepartmentName && Boolean(formik.errors.vDepartmentName)}
                  helperText={formik.touched.vDepartmentName && formik.errors.vDepartmentName}
