...
export default function HomePage() {
    ...
    const cardItems = [
        { text: "DashBoard", icon: <DashboardIcon /> ,onclick : () => navigate('/EmployeeDashBoard')  },
        { text: "Settings", icon: <SettingsIcon /> },
        { text: "Attendance", icon: <TodayIcon />, onclick : () => navigate('/BasicDate') },
        { text: "Leave", icon: <AssignmentIcon /> },
        { text: "Shift", icon: <AccessTimeIcon /> },
        { text: "Payslip", icon: <ReceiptIcon /> },
        { text: "Reimbursement", icon: <CurrencyExchangeIcon />, onclick : () => navigate('/ReimbursementForm') }, 
        { text: "Loan", icon: <RedeemIcon /> },
      ];
