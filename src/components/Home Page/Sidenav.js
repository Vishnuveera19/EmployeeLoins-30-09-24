  ...
  return (
    <Box sx={{ display: 'flex', height: '100vh' }}>
      ...
      <Drawer variant="permanent" open={open} sx={{ display: { xs: 'none', sm: 'block' } }}>
        ...
        <ListItem disablePadding sx={{ display: "block" }}  onClick={() => navigate("/EmployeeDashBoard")}>
            <ListItemButton
              sx={{
                minHeight: 48,
          ...
          <ListItem disablePadding sx={{ display: "block" }} onClick={() => navigate("/BasicDate")}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",
...
{/* 
  ...
  <ListItem disablePadding sx={{ display: "block" }}  onClick={() => navigate("/HolidaysHrPage")}>
          ...
          {open && (
            <Collapse in={openSalary} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                ...
                <ListItem disablePadding sx={{ display: "block" }} onClick={() => navigate("/LeaveBalances")}>
                  <ListItemButton
                    sx={{
                      minHeight: 48,
                      justifyContent: open ? "initial" : "center",
          ...
          <ListItem disablePadding sx={{ display: "block" }}  onClick={() => navigate("/ReimbursementForm")}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",
