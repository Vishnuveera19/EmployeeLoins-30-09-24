...
import App001 from "./components/calender";
import AttendanceTable from "./components/calendertable";
import Legends from "./components/Shoatt";
import LegendsDrawer from "./components/Shoatt";
import Legend from "./components/Shoatt";
import LegendDropdown from "./components/Shoatt";
import DailyTimesheetForm from "./components/Timesheet/daily/DailyTimesheetForm";
import Dashboard from "./components/Home Page/Dashbored12";
import GraphCheckBox1 from "./components/Home Page/dashcheck";
import PaymCategoryForm from "./components/Masters/CategoryMaster";
import JobStatusForm22 from "./components/Masters/JobStatusMaster";
import LevelForm33 from "./components/Masters/LevelMaster";
import BasicTable from "./components/Masters/Attendance";
import DepartForm from "./components/Masters/DepartmentMasters";
import LeaveapplyHr from "./components/Masters/Leaveapply/Leaveapply";
import LeaveRequestTable from "./components/Masters/Leaveapply/LeaveApplyHistory";
import HolidaysHrPage from "./components/Masters/Holidayemp/Holidayemp";
import LeaveBalances from "./components/Masters/Leaveapply/LeaveBalance";
import LeaveBalanceForm from "./components/Masters/Leaveapply/LeaveBalance";
import HolidaysPage from "./components/Masters/Leaveapply/Holiday";
import ReimbursementForm from "./components/Masters/Reimbursement";
    ...
    <BrowserRouter>
      ...
      <Routes>
        <Route path="/" element={<App />}>
          ...
          <Route path="/Legend" element={<Legend/>}></Route>
          <Route path="/shott" element={< LegendDropdown/>}></Route>
<Route path="/Dashboard" element={<Dashboard/>}></Route>
<Route path="/GraphCheckBox1" element={<GraphCheckBox1/>}></Route>
<Route path="/categorymaster" element={<PaymCategoryForm/>}></Route>
<Route path="/status22" element={<JobStatusForm22/>}></Route>
<Route path="/Level33" element={<LevelForm33/>}></Route>

<Route path="/basic1" element={< BasicTable/>}></Route>

<Route path="/depart" element={< DepartForm/>}></Route>
<Route path="/BasicDate" element={< BasicDateCalendar/>}></Route>

<Route path="/EmployeeDashBoard" element={<EmployeeDashBoard/>}></Route>

<Route path="/LeaveapplyHr" element={<LeaveapplyHr/>}></Route>
<Route path="/LeaveRequestTable" element={<LeaveRequestTable/>}></Route>
<Route path="/HolidaysHrPage" element={<HolidaysHrPage  />}></Route>
<Route path="/LeaveBalances" element={<LeaveBalances/>}></Route>
<Route path="/HolidaysPage" element={<HolidaysPage/>}></Route>
<Route path="/ReimbursementForm" element={<ReimbursementForm/>}></Route>
